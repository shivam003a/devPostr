...
export default function Modal({ children, open, setOpen, headerTitle, verticalAlign = "items-center" }) {
    ...
    return (
        ...
        >
            <div className="max-w-[900px] w-full max-h-[450px] h-full sm:w-[700px] bg-dark-blue p-4 rounded-lg overflow-hidden m-2"
                onClick={(e) => e.stopPropagation()}
            >
                <div className='flex items-center justify-between pb-4'>
                    <span className='text-white font-poppins'>{headerTitle}</span>
                    <span
                        onClick={() => setOpen(false)}
